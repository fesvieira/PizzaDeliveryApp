...
class SweetAdapter(private val viewModel: OrderViewModel) : RecyclerView.Adapter<SweetAdapter.FlavorViewHolder>() {
    ...
    override fun getItemCount(): Int { return sweetPizzas.size }
}

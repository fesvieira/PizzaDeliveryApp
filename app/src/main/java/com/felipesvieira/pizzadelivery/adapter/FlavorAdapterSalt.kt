...
class FlavorAdapterSalt(private val viewModel: OrderViewModel) : RecyclerView.Adapter<FlavorAdapterSalt.FlavorViewHolder>() {
    ...
    override fun onBindViewHolder(holder: FlavorViewHolder, position: Int) {
        ...
        holder.priceItem.text = "$ " + item.flavorPrice.toString()
